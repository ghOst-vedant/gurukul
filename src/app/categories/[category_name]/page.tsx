...
const page = () => {
  ...
  return (
    <div className="p-4 pt-28 sm:p-12 sm:pt-28 lg:p-16 lg:pt-32 flex flex-col gap-10 sm:gap-8 lg:gap-12">
      ...
      <div className="flex flex-col sm:gap-4">
        ...
        <div className="mt-5 overflow-x-scroll lg:overflow-x-hidden lg:flex lg:justify-between">
          <CourseCard />
          <CourseCard />
          <CourseCard />
          <CourseCard />
