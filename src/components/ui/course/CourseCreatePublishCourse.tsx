    ...
    <div className="w-full shadow flex flex-col h-fit rounded-lg">
      ...
      <div className="p-8 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-2xl font-medium">Title : {basicDetails.title}</h2>
          <h3 className="text-xl font-normal">
            Subtitle : {basicDetails.subtitle}
          </h3>
          <p className="mt-2">Description : {basicDetails.description}</p>
          <p className="mt-2">Language : {basicDetails.language}</p>
          <p className="mt-2">Difficulty Level : {basicDetails.difficulty}</p>
              ...
              <h3
                ...
                onClick={() => {
                  setExpandSection((prev) =>
                    prev === section.sectionId ? "" : section.sectionId
                  );
                }}
              >
                <IoIosArrowForward
                  ...
                  <>
                    {content.type === "lecture" ? (
                      <span className="flex gap-2 items-center">
                        ...
                        {(content.data as Lecture).lectureTitle}
                      </span>
        ...
        <div className="flex flex-col gap-4">
          <p>Course is paid : {pricing.isCourseFree ? "No" : "Yes"}</p>
